...
public class ReOrder {
        ...
        private String cart_id, user_id,product_id,unit,messarment,cost,total_;
        private String total_grand, currency, total_unit, total_price, total_weight;
        private String category_id, product_name, product_name_ar, product_code,product_description;
        private String product_description_ar, thumbnail, image_url;
    ...
    public String getMessarment() {
        return messarment;
    }

    public void setMessarment(String messarment) {
        this.messarment = messarment;
    }
